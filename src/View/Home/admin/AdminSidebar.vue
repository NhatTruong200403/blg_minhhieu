    ...
    <aside class="admin-sidebar">
      ...
      <nav>
        <ul>
          ...
          <li>
            <router-link :to="{ name: 'ListBlogs' }" active-class="active-link">
               <i class="fas fa-box-open"></i> Danh sách blogs
            </router-link>
          </li>
          <li>
            <router-link :to="{ name: 'ListTypies' }" active-class="active-link">
               <i class="fas fa-copyright"></i> Thể loại
            </router-link>
          </li>
...
import AuthService from '../../../service/api/AuthService';
  ...
  nav a i {
      ...
      font-size: 0.7em; /* Icon lớn hơn chút */
  }
  ...
  nav a.active-link {
    ...
    font-size: 0.7em; /* Kích thước chữ lớn hơn khi active */
    font-weight: 500;
